...
class TelemetryClient:
    ...
    def parse_telemetry_data(self, arbitration_id, data): # data comes pre-received from the input loop
        ...
        try:
          ...
          # The `parse_telemetry_data` method in the `TelemetryClient` class is responsible for
          # parsing the telemetry data received from the CAN bus. It takes the arbitration ID and data
          # as input parameters and processes them based on the ID to identify the type of telemetry
          # data being received.

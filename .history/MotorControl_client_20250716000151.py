...
class MotorControlClient:
            ...
            if response.sender == "dashboard" and response.command.startswith("motor:"):
                try:
                    ...
                    if len(command_parts) >= 3:
                        ...
                        # Convert to bytes format for CAN message - THIS LINE WAS MISSING!
    ...
    #         # Log command type for debugging (UPDATED with correct command codes)
    #         if len(data) > 0:
    #             cmd_type = {0: "IDLE", 17: "STOP", 34: "START", 51: "THROTTLE", 68: "DIRECTION"}.get(data[0], "UNKNOWN")

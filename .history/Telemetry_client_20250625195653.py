        ...
        try:
            ...
            if arbitration_id == '0x1e': # BMS STM32 Board CAN ID, should not be a string when testing with CAN
                ...
                if len(data_bytes) <= 8:
                    ...
                    return f"Telemetry:     : MUX1_TEMP={MUX1_TEMP}, MUX2_TEMP={MUX2_TEMP}, MUX3_TEMP={MUX3_TEMP}, MUX4_TEMP={MUX4_TEMP}, MUX5_TEMP={MUX5_TEMP}, MUX6_TEMP={MUX6_TEMP}, ERROR_ID={ERROR_ID}"
                else:

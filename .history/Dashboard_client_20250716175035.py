...
class DashboardClient:
    ...
    def input_loop(self):
        ...
        print("   - 'start:THROTTLE' to start motor (throttle 1-100)")
        print("   - 'stop' to stop motor")
        print("   - 'throttle:VALUE' to set throttle (1-100)")
        print("   - 'forward' to set direction forward")
        print("   - 'reverse' to set direction reverse")
        print("   - 'direction' to set direction forward (default)") # REMOVE THIS
        print("   - 'idle' to set motor to idle") # remove IDLE
        ...
        while not self._stop_event.is_set():
            try:
                ...
                # Motor Control Commands (using correct CAN ID 0x123 = 291 from can.c)
                    ...
                    command = f"motor:291:68,1"  # MC_DIRECTION (0x44 = 68), default to forward
                    print("[Dashboard] Setting direction to FORWARD (default)")
                    ...
                    print("[Dashboard] Setting motor to idle")

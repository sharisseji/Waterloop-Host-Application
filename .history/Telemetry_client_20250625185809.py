...
class TelemetryClient:
    """
    TelemetryClient manages the connection to a gRPC host server, handles user input for telemetry data,
    and streams CAN messages to a dashboard client, supporting both random and custom CAN message formats.
    """

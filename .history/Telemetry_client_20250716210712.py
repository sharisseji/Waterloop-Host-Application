...
class TelemetryClient:
    ...
    def parse_telemetry_data(self, arbitration_id, data): # data comes pre-received from the input loop
        ...
        try:
            ...
            if arbitration_id == BMS_ID: # BMS STM32 Board CAN ID, should not be a string when testing with CAN
            ...
            elIF arbitration_id == : # don't have the ID of the IMU yet, string for testing, hex/binary for CAN bus
